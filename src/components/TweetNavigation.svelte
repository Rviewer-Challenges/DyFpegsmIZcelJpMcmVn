<script>
    ...
    const navigationList = [
      {
        label: 'Twitter', type: NAVIGATION_ITEM_TYPES.ImageOnly, icon: 'https://cdn-icons-png.flaticon.com/512/733/733579.png', selected: true,
      },
      { label: 'Inicio', type: NAVIGATION_ITEM_TYPES.FontIcon, icon: 'e88a' },
